...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        print("Documents: \(getDocumentsDirectory())")
...
//        button1.layer.borderColor = UIColor(red: 1.0, green: 0.6, blue: 0.2, alpha: 1.0).cgColor
    ...
    func checkCurrentScore(score: Int) {
        let userdefaults = UserDefaults.standard
        let savedScore = userdefaults.integer(forKey: "score")
        print("Current score: \(savedScore)")
        if score > savedScore {
            userdefaults.set(score, forKey: "score")
            
            let ac = UIAlertController(title: "New high score", message: "Congrats, you have a new high score!", preferredStyle: .alert)
